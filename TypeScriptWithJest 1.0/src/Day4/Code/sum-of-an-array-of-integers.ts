...
//Method Declaration
export const getSumOfArrayOfIntegersWithWhileLoop = ((inputArrayForWhileLoop:number[])=>
{
...
//Method Declaration
export const getSumOfArrayOfIntegersWithInbuiltFunction = ((inputArrayForWhileLoop:number[])=>
{
